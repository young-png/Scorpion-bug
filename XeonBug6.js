...
//time
const xtime = moment.tz('Lagos/Nigeria').format('HH:mm:ss')
        const xdate = moment.tz('Lagos/Nigeria').format('DD/MM/YYYY')
        const time2 = moment().tz('Lagos/Nigeria').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
